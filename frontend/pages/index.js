...
export default function Home() {
  ...
  const services = [
    {
      ...
      description: "Développement de landing pages et de sites web modernes avec Next.js. Création et personnalisation de sites vitrines pour des besoins marketing et consulting."
    },
    {
      title: "Web Scraping & Automation",
      description: "Développement de scripts Python pour l'extraction automatisée de données publiques provenant de sites professionnels et annuaires. Utilisation de BeautifulSoup, Scrapy et Selenium."
    },
    {
      title: "CRM & Data Integration",
      description: "Collecte d'informations professionnelles pour la génération de leads. Intégration des données dans un CRM ou fichier Excel pour aider l'équipe commerciale dans la prospection ciblée."
    },
    {
      title: "CMS Development",
      description: "Création et développement de sites web avec CMS WORDPRESS. Expérience chez IT ADVISOR en tant que développeur informatique."
    }
  ];
  ...
  useEffect(() => {
    const options = {
      strings: ['Web Developer', 'Web Scraping Expert', 'Python Automation'],
      typeSpeed: 50,
      backSpeed: 25,
      backDelay: 1000,
      startDelay: 500,
  ...
  return (
    <>
      ...
      <section className="services">
        <div className="container">
          <div className="services_titles">
            ...
            <p data-aos="fade-up">Développement de solutions web et d'extraction de données pour la génération de leads et la prospection ciblée.</p>
          </div>
      ...
      <section className="projects">
        <div className="container">
          <div className="project_titles">
            ...
            <p data-aos="fade-up">Développement de landing pages, sites web modernes et scripts d'automatisation Python.</p>
          </div>
      ...
      {/* My Skills - COMPLETELY UNCHANGED */}
